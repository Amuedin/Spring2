...
//@ContextConfiguration(classes = {SystemTestConfig.class}) // Replace me
    //SpringBootTest arranca tod el contexto, y por tanto los CommandLineRunner
@SpringBootTest //(classes={SystemTestConfig.class})si definimos alguna clase de configuración, autoconfig se desactiva
